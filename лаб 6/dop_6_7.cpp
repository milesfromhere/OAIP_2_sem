...
public:
    ...
    void sumOfNegativeElementsWithLastDigit3() {
        Node* current = head;
        int sum = 0;
        ...
        if (sum != 0) {
            std::cout << "Сумма отрицательных элементов с последней цифрой 3: " << sum << "\n";
        }
        else {
            std::cout << "Нет отрицательных элементов с последней цифрой 3.\n";
        }
    }
};
...
int main() {
    ...
    do {
        ...
        std::cout << "7. Найти сумму отрицательных элементов с последней цифрой 3\n";
        std::cout << "8. Выход\n";
        ...
        case 6:
            ...
            break;
        case 7:
            list.sumOfNegativeElementsWithLastDigit3();
            break;
        case 8:
