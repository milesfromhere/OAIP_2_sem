...
public:
    ...
    void sumOfPositiveMultiplesOf5() {
        Node* current = head;
        int sum = 0;
        ...
        if (sum != 0) {
            std::cout << "Сумма положительных элементов, кратных 5: " << sum << "\n";
        }
        else {
            std::cout << "Нет положительных элементов, кратных 5.\n";
        }
    }
};
...
int main() {
    ...
    do {
        ...
        std::cout << "7. Найти сумму положительных элементов, кратных 5\n";
        std::cout << "8. Выход\n";
        ...
        case 6:
            ...
            break;
        case 7:
            list.sumOfPositiveMultiplesOf5();
            break;
        case 0:
