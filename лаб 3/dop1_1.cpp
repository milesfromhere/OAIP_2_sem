...
int main()
{
    ...
    char str1[100] = "in the sun day sun blind me";
    char str2[100] = "the bstu is the best";
    char str3[100] = "glassy sky and white moon";
    ...
    else
    {
        ...
        //добавляем нулевой символ к последней строке двумерного массива
        words1[row][symb] = '\0'; 
        //хранит число строк
        length = row + 1; 
        ...
        char string[] = "ya o43n h0chy d0m01 ";
        int kol = 0;
        int numofword = 0;
        int numofwordmax = 0;
        int max = kol;
